...
builder.Services.Configure<TeamDirectoryOptions>(builder.Configuration.GetSection("TeamService"));
builder.Services.AddHttpClient<ITeamDirectory, TeamDirectoryClient>();
