...
public class AppDbContext(DbContextOptions<AppDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        ...
        b.Entity<ScoreEvent>()
            .HasIndex(se => se.TeamId);
        b.Entity<ScoreEvent>()
            .HasIndex(se => se.PlayerId);
        ...
        // RoleMenu
        b.Entity<RoleMenu>()
            .HasIndex(rm => rm.MenuId);
        b.Entity<RoleMenu>()
            .HasIndex(rm => rm.RoleMenuId);
        b.Entity<RoleMenu>()
        ...
        b.Entity<RoleMenu>()
            .HasOne(rm => rm.Parent)
            .WithMany(r => r.RoleMenus)
            .HasForeignKey(rm => rm.RoleMenuId)
            .OnDelete(DeleteBehavior.NoAction);
        ...
        b.Entity<Player>()
            ...
            .OnDelete(DeleteBehavior.Cascade);
        b.Entity<Player>()
            .HasIndex(p => new { p.TeamId, p.Number })
            .IsUnique()
